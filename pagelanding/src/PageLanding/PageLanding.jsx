  ...
  return (
    <div>
        <header className='header'>
          <img src={ require('../img/product-landing-page-logo.png' )}alt='no internet' className='headeer-img' />
        ...
        <div className='row video-frame'>
          <div className="col-sm-6">
          <iframe className='iframe-video' width="560" height="315" src="https://www.youtube.com/embed/y8Yv4pnO7qc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" id="video" allowfullscreen></iframe>
          </div>
        </div>
